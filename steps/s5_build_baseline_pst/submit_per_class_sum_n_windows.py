...
path_to_python_script_to_run = '/cs/icore/amir.rubin2/code/snpnmi/sanity_check/per_class_sum_n_windows.py'
    ...
    for mac_maf in ['mac', 'maf']:
        ...
        if min_range > 0:
            ...
            for val in range(min_range, max_range + 1):
                ...
                num_windows = get_number_of_windows_by_class(paths_helper)[str(val)]
                max_window_id = 0
