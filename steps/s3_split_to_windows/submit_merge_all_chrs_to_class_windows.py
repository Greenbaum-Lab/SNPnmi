        ...
        if min_range > 0:
            ...
            for class_int_val in range(min_range, max_range+1):
                ...
                for min_windows_index in range(0, total_num_windows, max_num_of_windows_per_job):
                    ...
                    python_script_params = f'-d {dataset_name} --args {mac_maf},{class_int_val},{min_windows_index},{max_windows_index}'
                    submit_to_cluster(dataset_name, job_type, job_long_name, job_name, path_to_python_script_to_run,
